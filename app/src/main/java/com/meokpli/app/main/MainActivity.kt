...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        // 2) NavController는 NavHostFragment에서 직접 꺼낸다
        val navHost =
        ...
        navHome.setOnClickListener { handleTabReselection(R.id.homeFragment) }
        navSearch.setOnClickListener { handleTabReselection(R.id.searchFragment) }
        navFeed.setOnClickListener { handleTabReselection(R.id.feedFragment) }
        navStar.setOnClickListener { handleTabReselection(R.id.starFragment) }
        navProfile.setOnClickListener { handleTabReselection(R.id.profileFragment) }
